  ...
  return (
    <div className="w-full min-h-screen fixed top-0 left-0 z-10">
      <div
        ...
        onClick={() => onClose()}
      />
      <div className="w-11/12 max-h-full lg:w-fit px-8 py-8 flex flex-col gap-4 bg-white rounded-xl overflow-y-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
